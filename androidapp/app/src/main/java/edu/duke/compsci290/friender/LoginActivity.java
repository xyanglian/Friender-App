...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean userExist(){
        ...
        // if exist return true, which is (!= null)
        return !sharedPref.getString("username", "").equals("");
    }
    ...
    private boolean isEmailValid(String email) {
        ...
        return (android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches() && email.contains("duke.edu"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try{
                URL url = new URL(getString(R.string.vm_address) + "login");
                ...
                if (statusCode ==  200) {
                    ...
                    errorCode = jsonTotal.getInt("errorcode");
                    mUsername = jsonTotal.getString("username");
                    Log.d("loginerror", errorCode + "");
                    Log.d("logintotal", total.toString());
                }
                else{
                    errorCode = 4;
